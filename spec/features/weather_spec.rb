...
feature 'Weather', :weather do
  context 'Country/City weather' do
    scenario 'User can select Country/City to get weather' do
      getWeatherData({country: 'Egypt', city: 'Alexandria'})
    end
  ...
  context 'Location weather' do
    scenario 'User can use his location to get weather' do
